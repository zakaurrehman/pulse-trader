            ...
            <div className="bg-gold-50 border border-gold-200 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white rounded-xl border border-gold-200 p-4">
                  ...
                  <p className="text-sm text-slate-700">Message us on WhatsApp: <a href="https://wa.me/447386847811" target="_blank" rel="noopener noreferrer" className="text-gold-600 font-semibold hover:underline">+44 7386 847811</a></p>
                </div>
              </div>
