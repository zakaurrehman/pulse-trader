      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 mb-2 leading-relaxed">
            Your student account is ready. You can now log in and enroll in a course.
          </p>
          <p className="text-slate-400 text-sm mb-6">
            After enrolling and completing payment, your course will be unlocked automatically.
          </p>
          <Link
            href="/login"
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="border-t border-slate-100 pt-4">
              <h3 className="text-sm font-bold text-slate-700 mb-3">Set Your Password</h3>
              <div className="grid sm:grid-cols-2 gap-4">
